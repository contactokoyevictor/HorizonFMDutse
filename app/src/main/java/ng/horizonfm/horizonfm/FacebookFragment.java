...
public class FacebookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        htmlWebView = (WebView) view.findViewById(R.id.facebookwebview);
        spinner = (ProgressBar) view.findViewById(R.id.facebookprogressbar);
        ...
        //other references
        htmlWebView.setWebViewClient(new FacebookFragment.CustomWebViewClient());
        WebSettings webSetting = htmlWebView.getSettings();
        webSetting.setJavaScriptEnabled(true);
        webSetting.setDisplayZoomControls(true);
        htmlWebView.loadUrl("https://www.facebook.com/Radio-Nigeria-Horizon-FM-1005-Dutse-223397224921638/");
        return view;
    }
